...
INSTALLED_APPS = [
    'visitas_granada_app.apps.VisitasGranadaAppConfig',
...
MIDDLEWARE = [
    ...
    'django_web_project.my_middlewares.RESTMiddleware',
]
...
# Logging setup
# Descomentar para su funcionamiento en producción
# y comentar para facilidad de desarrollo.
